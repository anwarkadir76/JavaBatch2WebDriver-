...
public class AutomationTestingPractice {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
				...
				driver.findElement(By.id("RESULT_TextField-1")).sendKeys("anwar");
				driver.findElement(By.id("RESULT_TextField-2")).sendKeys("kadir");
				driver.findElement(By.id("RESULT_TextField-3")).sendKeys("7039406646");
				driver.findElement(By.id("RESULT_TextField-4")).sendKeys("USA");
				driver.findElement(By.id("RESULT_TextField-5")).sendKeys("Washngiton DC");
				driver.findElement(By.id("RESULT_TextField-6")).sendKeys("anwarkadir76@yahoo.com");
				...
				driver.findElement(By.id("id=\"RESULT_CheckBox-8_1\"")).click();
				...
				driver.findElement(By.id("RESULT_TextArea-12")).sendKeys(" this is automation testing fill up the free text massages in this text area ");
				...
				driver.findElement(By.linkText("Software Testing Tutorials")).click();// go to NewTour  website 
				...
				if(driver.getTitle()=="Automation Testing Practice - Atom")
				{
